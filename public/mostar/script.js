(function () {
  ...
  function setupSightSlider() {
    ...
    for (var setIndex = 0; setIndex < 3; setIndex++) {
      for (var cardIndex = 0; cardIndex < originalCards.length; cardIndex++) {
        var clone = originalCards[cardIndex].cloneNode(true);
  ...
  function updateSightSlider() {
    ...
    sightCards.forEach(function (card) {
      var isActive = Number(card.dataset.sightIndex) === activeSight;
